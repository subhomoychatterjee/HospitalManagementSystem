...
<%@ page import = "com.bean.Medicines" %>
<%@ page import = "com.bean.Diagonostics" %>
...
<body>
	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<div class="container-fluid">				
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow min-h200">
							<h3 class="widget-title">Final Bill</h3>
							...
							<table>
      						...
      						<div class="col-md-12">
								<div class="widget-area-2 proclinic-box-shadow">
									<h3 class="widget-title">Medicine Details</h3>
									<p class="margin-l20">
               ...
               try{
               List<Medicines> medlist = (ArrayList<Medicines>) request.getAttribute("medList");
               for(Medicines med : medlist) {          
                   %>
													<tr>
														<td><% if(med.getMedicine_name()!=null) %><%= med.getMedicine_name() %></td>
														<td><% if(med.getQuantity()!=0) %><%= med.getQuantity() %></td>
														<td><% if(med.getRate()!=0) %><%= med.getRate() %></td>
														<td><% if(med.getAmount()!=0) %><%= med.getAmount() %></td>														
													</tr>
													<% } %>
												</tbody>
											</table>
    ...
    } catch(Exception e) 
    {
         //out.println("data not found"+e);
							...
							<table>
								<tr>
   									<td><label for = "amt"><b>Amount for Pharmacy: </b></label></td>
    								<td><label id = "amt"><% if(request.getAttribute("med_bill")!=null) %><%= request.getAttribute("med_bill") %></label></td>
      							</tr>
      						</table>
      						
      						<div class="col-md-12">
								<div class="widget-area-2 proclinic-box-shadow">
									<h3 class="widget-title">Diagnostic Details</h3>
									<p class="margin-l20">
               ...
               try{
               List<Diagonostics> testlist = (ArrayList<Diagonostics>) request.getAttribute("testList");
               for(Diagonostics diag : testlist) {          
                   %>
													<tr>
														<td><% if(diag.getDiagonosis()!=null) %><%= diag.getDiagonosis() %></td>
														<td><% if(diag.getAmount()!=0) %><%= diag.getAmount() %></td>
													</tr>
    ...
    } catch(Exception e) 
    {
         //out.println("data not found"+e);
							...
							<table>
								<tr>
   									<td><label for = "amt"><b>Amount for Diagnostics: </b></label></td>
    								<td><label id = "amt"><% if(request.getAttribute("test_bill")!=null) %><%= request.getAttribute("test_bill") %></label></td>
      							</tr>
      						</table>
      						
      						<table>
								<tr>
   									<td><label for = "amt"><b>Grand total: </b></label></td>
    								<td><label id = "amt"><% if(request.getAttribute("finalBill")!=null) %><%= request.getAttribute("finalBill") %></label></td>
      							</tr>
      						</table>
