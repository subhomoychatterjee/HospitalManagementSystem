...
<body>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow min-h200">
							<h3 class="widget-title">Medicines Issued</h3>
                            <form action="MedsIssued" method="get">
							<table>
								<tr>
    ...
    } catch(Exception e) 
    {
         //out.println("data not found"+e);
							...
							<a class="btn btn-primary" type="submit" href="MedsToBeIssued.jsp">Issue Medicines</a>
