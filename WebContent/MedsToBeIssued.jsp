...
<head>
	...
	<title>Medicines to be Issued</title>
	<!-- Bootstrap core CSS -->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow min-h200">
							<h3 class="widget-title">Medicines to be Issued</h3>
							...
							<table>
								<tr>
                                    ...
                                    <td><input class="btn btn-primary" type="submit" name="btn" value="Search"></td>
    							</tr>
 
								<tr>
									<td><label for = "medName"><b>Medicine Name: </b></label></td>
    								<td><input type = "text" name = "med_name" id = "medName" required></td>
    							</tr>

    							<tr>
									<td><label for = "quan"><b>Quantity: </b></label></td>
    								<td><input type = "text" name = "quantity" id = "quantity" required></td>
    							</tr>

    							<tr>
									<td><label for = "rate"><b>Rate: </b></label></td>
