...
<body>
	...
	<div class="wrapper">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow min-h200">
							<h3 class="widget-title">Delete Patient Details</h3>
    	<form id="new" action = "PatientDelete" method="post">
    	<table>
    	<tr>
              <td><b>Patient ID: </b></td>
              <td><input type="text" pattern="[1-9]{1}[0-9]{8}" name="patient_id" placeholder="Patient ID" required></td>
              <td><input type="submit"name="btn" class = "btn btn-primary" value="Search"></td>
        </tr>
        <tr>
                 ...
                 <% } else { %>
      		     <td><input type="text" name="patient_name" value="<%= request.getAttribute("name") %>" /></td>
      		     <% } %>
      		</tr>
            <tr>
                 ...
                 <td><input type="text" disabled value="" /></td>
                 <% } else { %>
      		     <td><input type="text" pattern="[0-9]{2}" name="age" value="<%= request.getAttribute("age") %>" /></td>
      		     <% } %>
      		</tr>

      		<tr>
                 <td><b>Date of Admission: </b></td>
                 <% if(request.getAttribute("doj")==null){ %>
                 <td><input type="text" disabled value="" /></td>
                 <% } else { %>
      		     <td><input type="text" name="doj" value="<%= request.getAttribute("doj") %>" /></td>
      		     <% } %>
      		</tr>

      		<tr>
                 <td><b>Type of Bed: </b></td>
                 <% if(request.getAttribute("room_type")==null){ %>
                 <td><input type="text" disabled value="" /></td>
                 <% } else { %>
      		     <td><input type="text" name="room_type" value="<%= request.getAttribute("room_type") %>" /></td>
      		     <% } %>
  			</tr>
      		...
      		<tr>
                 ...
                 <td><input type="text" style="height:50px;" disabled value="" /></td>
                 <% } else { %>
      		     <td><input type="text" style="height:50px;" name="address" value="<%= request.getAttribute("address") %>" /></td>
      		     <% } %>
      		</tr>
    	...
    	<input type="submit" name="btn" class="btn btn-primary" value="Delete">
    	</form>
     </div>
					</div>
				</div>
