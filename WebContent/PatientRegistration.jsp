		...
		<div id="content">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow min-h200">
							<h3 class="widget-title">New Registration</h3>
    		<form id="new" action = "PatientRegistration" method="post">
    		<table>
    		<tr>
                 <td><b>Patient SSN ID: </b></td>
                  <td><input type="text" name="ssn" placeholder="Patient SSN ID" required></td>
            </tr>
            ...
            <tr>
                 <td><b>Patient Age: </b></td>
      		     <td><input type = "text" name = "age" placeholder="Patient Age" required></td>
      		</tr>
      		...
      		<tr>
                 <td><b>Address: </b></td>
      		     <td><input type = "text" name = "address" placeholder="Address" style="height:50px;" required></td>
      		</tr>
    		...
    		<tr>
    		     ...
    		     <td><input type="reset" class="btn btn-primary" onclick="myFunction()" value="Reset"></td>
    		 </tr>
    		 </table>
							</form>
						</div>
