				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow min-h200">
							<h3 class="widget-title">Update Patient Details</h3>
							<form id="new" action = "PatientUpdate" method="post">
    	<table>
    	<tr>
              <td><b>Patient ID: </b></td>
              <td><input type="text" name="patient_id" placeholder="Patient ID" required></td>
