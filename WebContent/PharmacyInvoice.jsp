				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow min-h200">
							<h3 class="widget-title">Pharmacy Invoice</h3>
                            <form action="MedInvoice" method="get">
							<table>
								<tr>
         ...
         //out.println("data not found"+e);
							...
							<table>
								<tr>
    								...
    								<td><label id = "amt"><% if(request.getAttribute("bill")!=null) %><%= request.getAttribute("bill") %></label></td>
      							</tr>
      						</table>
                           </form>
						</div>
