...
<body>
	...
	<div class="wrapper">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow min-h200">
							<h3 class="widget-title">Search Patients</h3>
							<form id="new" action = "PatientSearch" method="get">
    	<table>
    	<tr>
              <td><b>Patient ID: </b></td>
              <td><input type="text" name="patient_id" placeholder="Patient ID" pattern="[1-9]{1}[0-9]{8}" required></td>
        ...
        <tr>
                 ...
                 <% } else { %>
      		     <td><input type="text" disabled value="<%= request.getAttribute("name") %>" /></td>
      		     <% } %>
      		</tr>
            <tr>
                 ...
                 <td><input type="text" disabled value="" /></td>
                 <% } else { %>
      		     <td><input type="text" disabled value="<%= request.getAttribute("age") %>" /></td>
      		     <% } %>
      		</tr>
      		...
      		<tr>
                 ...
                 <td><input type="text" disabled value="" /></td>
                 <% } else { %>
      		     <td><input type="text" disabled value="<%= request.getAttribute("doj") %>" /></td>
      		     <% } %>
      		</tr>
      		...
      		<tr>
                 ...
                 <td><input type="text" disabled value="" /></td>
                 <% } else { %>
      		     <td><input type="text" disabled value="<%= request.getAttribute("room_type") %>" /></td>
      		     <% } %>
  			</tr>
      		...
      		<tr>
                 ...
                 <td><input type="text" disabled value="" /></td>
                 <% } else { %>
      		     <td><input type="text" style="height:50px;" disabled value="<%= request.getAttribute("address") %>" /></td>
      		     <% } %>
      		</tr>
