...
<body>
	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<div class="row no-margin-padding">
				<div class="col-md-6">
					<h3 class="block-title">Diagnostics</h3>
				</div>
				<div class="col-md-6">
					<ol class="breadcrumb">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow min-h200">
							<h3 class="widget-title">Tests Conducted</h3>
                            <form action="TestsIssued" method="get">
							<table>
								<tr>
							...
							<div class="col-md-12">
								<div class="widget-area-2 proclinic-box-shadow">
									<h3 class="widget-title">Diagnostics Details</h3>
									<p class="margin-l20">
    ...
    } catch(Exception e) 
    {
         //out.println("data not found"+e);
							...
							<a class="btn btn-primary" type="submit" href="TestsToBeConducted.jsp">Add Tests</a>
						</div>
					</div>
				</div>
