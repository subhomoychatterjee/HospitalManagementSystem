...
<%@ page import = "com.service.PatientService" %>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow min-h200">
							<h3 class="widget-title">View Patient Details</h3>
    	<table border="1">
    	   <tr>
    	      <th>Patient ID</th>
    	      <th>Name</th>
    	   ...
    	   <%
               try{
                  ...
                  List<Patient> patList = ps.ViewPatient();     
                  for (Patient pat : patList) {            
                   %>
           <tr>
              <td><%= pat.getPatient_id() %></td>
              <td><%= pat.getPatient_name() %></td>
              <td><%= pat.getAge() %></td>
              <td><%= pat.getAddress() %></td>
              <td><%= (Date)pat.getDoj() %></td>
              <td><%= pat.getRoom_type() %></td>
           </tr>
           <% } %>
    	</table>
    	<% 
